...
TF1* fitDataG_P1(Double_t momentum, TString imagesDir, TH1F* histo,
    ...
    Double_t fitMin = 0.0;
    Double_t fitMax = 1.0;
    Double_t fitConstant = 1.0;  //1200.0
    Double_t fitMean = 1.0;  //1.4
    Double_t fitSigma = 1.0;  //0.5
    Double_t fitBkg0 = 1.0;  //1.0
    Double_t fitBkg1 = 1.0;  //0.0
    ...
    if (mom4 && partPim) {
        fitMin = 0.85;  fitMax = 3.00;
        fitConstant = 1.0;  fitMean = 1.5; fitSigma = 0.5;
        fitBkg0 = 0.01;  fitBkg1 = -0.01;
    }
    else if (mom6 && partPim) {
        fitMin = 1.25;  fitMax = 4.50;
        fitConstant = 1.0;  fitMean = 1.5; fitSigma = 0.5;
        fitBkg0 = 0.01;  fitBkg1 = -0.01;
    }
    else if (mom8 && partPim) {
        fitMin = 1.50;  fitMax = 5.00;
        fitConstant = 1.0;  fitMean = 1.5; fitSigma = 0.5;
        fitBkg0 = 0.01;  fitBkg1 = -0.01;
    }
    ...
    if (mom4) {yUp = 0.04; xUp = 4.80;}
    else if (mom6) {yUp = 0.040; xUp = 7.20;}
    else if (mom8) {yUp = 0.040; xUp = 9.60;}
...
TF1* fitMCG_P1(Double_t momentum, TString imagesDir, TH1F* histo,
    ...
    if (mom4 && partPim) {
        fitMin = 0.65;  fitMax = 3.00;
        fitConstant = 1200.0;  fitMean = 1.5; fitSigma = 0.5;
        fitBkg0 = 0.01;  fitBkg1 = -0.01;
    }
    else if (mom6 && partPim) {
        fitMin = 1.00;  fitMax = 4.50;
        fitConstant = 1200.0;  fitMean = 1.5; fitSigma = 0.5;
        fitBkg0 = 0.01;  fitBkg1 = -0.01;
    }
    else if (mom8 && partPim) {
        fitMin = 1.25;  fitMax = 5.00;
        fitConstant = 1200.0;  fitMean = 1.5; fitSigma = 0.5;
        fitBkg0 = 0.01;  fitBkg1 = -0.01;
    }
    ...
    if (mom4) {yUp = 1000.0; xUp = 4.80;}
    else if (mom6) {yUp = 1000.0; xUp = 7.20;}
    else if (mom8) {yUp = 1000.0; xUp = 9.60;}
...
void beamPositionScanPlot () {
    ...
    TString imagesDir = "~/Projects/ANL/bbcal/images_newGeo/pim/v2.1/paper/beamPositionScan/";
    ...
    //TFile mcFile("~/Projects/ANL/bbcal/histos_newGeo/v2.1/paper/paperHistosAll3.root", "READ");
    ...
    TH1F *hPion_mc_kB132_FTFP_BERT_4_Low_U = (TH1F*) mcFile.Get("hPimCal_4.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_50.3_33.7_U");
    TH1F *hPion_mc_kB132_FTFP_BERT_4_Nom_U = (TH1F*) mcFile.Get("hPimCal_4.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_50.3_37.3_U");
    TH1F *hPion_mc_kB132_FTFP_BERT_4_High_U = (TH1F*) mcFile.Get("hPimCal_4.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_50.3_40.9_U");

    TH1F *hPion_mc_kB132_FTFP_BERT_6_Low_U = (TH1F*) mcFile.Get("hPimCal_6.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_29.4_2.6_U");
    TH1F *hPion_mc_kB132_FTFP_BERT_6_Nom_U = (TH1F*) mcFile.Get("hPimCal_6.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_29.4_14.3_U");
    TH1F *hPion_mc_kB132_FTFP_BERT_6_High_U = (TH1F*) mcFile.Get("hPimCal_6.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_29.4_26.0_U");

    TH1F *hPion_mc_kB132_FTFP_BERT_8_Low_U = (TH1F*) mcFile.Get("hPimCal_8.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_20.6_4.4_U");
    TH1F *hPion_mc_kB132_FTFP_BERT_8_Nom_U = (TH1F*) mcFile.Get("hPimCal_8.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_20.6_7.3_U");
    TH1F *hPion_mc_kB132_FTFP_BERT_8_High_U = (TH1F*) mcFile.Get("hPimCal_8.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_20.6_10.2_U");
    ...
    //---------------Plot--------------------------------------------------
    TCanvas *c4= new TCanvas("c4beamPosition","c4beamPosition", 1200, 800);
    ...
    leg4->AddEntry(scaledMC_4_kB132_FTFP_BERT_Low, "MC: mean = -33.7 mm", "el");
    leg4->AddEntry(scaledMC_4_kB132_FTFP_BERT_Nom, "MC: mean = -37.3 mm", "el");
    leg4->AddEntry(scaledMC_4_kB132_FTFP_BERT_High, "MC: mean = -40.9 mm", "el");
    leg4->Draw();
    ...
    c4->Print(imagesDir + "pion4GeVbeamPosition.pdf");


    TCanvas *c6= new TCanvas("c6beamPosition","c6beamPosition", 1200, 800);
    ...
    leg6->AddEntry(scaledMC_6_kB132_FTFP_BERT_Low, "MC: mean = -2.6 mm", "el");
    leg6->AddEntry(scaledMC_6_kB132_FTFP_BERT_Nom, "MC: mean = -14.3 mm", "el");
    leg6->AddEntry(scaledMC_6_kB132_FTFP_BERT_High, "MC: mean = -26.0 mm", "el");
    leg6->Draw();
    ...
    c6->Print(imagesDir + "pion6GeVbeamPosition.pdf");


    TCanvas *c8= new TCanvas("c8beamPosition","c8beamPosition", 1200, 800);
    ...
    leg8->AddEntry(scaledMC_8_kB132_FTFP_BERT_Low, "MC: mean = -4.4 mm", "el");
    leg8->AddEntry(scaledMC_8_kB132_FTFP_BERT_Nom, "MC: mean = -7.3 mm", "el");
    leg8->AddEntry(scaledMC_8_kB132_FTFP_BERT_High, "MC: mean = -10.2 mm", "el");
    leg8->Draw();
    ...
    c8->Print(imagesDir + "pion8GeVbeamPosition.pdf");
