...
void pListScanPlot () {
    ...
    TString imagesDir = "~/Projects/ANL/bbcal/images_newGeo/pim/v2.1/paper/pListScan/";
    //TString imagesDir = "~/Projects/ANL/bbcal/images_newGeo/pim/v2.1/paper/FTFP_BERT/";
    ...
    TH1F *hPion_mc_kB132_QGSP_BERT_4_0_U = (TH1F*) mcFile.Get("hPimCal_4.0GeV_APC_TC_kB132_Adjusted_QGSP_BERT_50.3_37.3_U");
    TH1F *hPion_mc_kB132_FTFP_BERT_4_0_U = (TH1F*) mcFile.Get("hPimCal_4.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_50.3_37.3_U");
    TH1F *hPion_mc_kB132_FTFP_BERT_HP_4_0_U = (TH1F*) mcFile.Get("hPimCal_4.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_HP_50.3_37.3_U");
    TH1F *hPion_mc_kB132_QGSP_BERT_HP_4_0_U = (TH1F*) mcFile.Get("hPimCal_4.0GeV_APC_TC_kB132_Adjusted_QGSP_BERT_HP_50.3_37.3_U");

    TH1F *hPion_mc_kB132_QGSP_BERT_6_0_U = (TH1F*) mcFile.Get("hPimCal_6.0GeV_APC_TC_kB132_Adjusted_QGSP_BERT_29.4_14.3_U");
    TH1F *hPion_mc_kB132_FTFP_BERT_6_0_U = (TH1F*) mcFile.Get("hPimCal_6.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_29.4_14.3_U");
    TH1F *hPion_mc_kB132_FTFP_BERT_HP_6_0_U = (TH1F*) mcFile.Get("hPimCal_6.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_HP_29.4_14.3_U");
    TH1F *hPion_mc_kB132_QGSP_BERT_HP_6_0_U = (TH1F*) mcFile.Get("hPimCal_6.0GeV_APC_TC_kB132_Adjusted_QGSP_BERT_HP_29.4_14.3_U");

    TH1F *hPion_mc_kB132_QGSP_BERT_8_0_U = (TH1F*) mcFile.Get("hPimCal_8.0GeV_APC_TC_kB132_Adjusted_QGSP_BERT_20.6_7.3_U");
    TH1F *hPion_mc_kB132_FTFP_BERT_8_0_U = (TH1F*) mcFile.Get("hPimCal_8.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_20.6_7.3_U");
    TH1F *hPion_mc_kB132_FTFP_BERT_HP_8_0_U = (TH1F*) mcFile.Get("hPimCal_8.0GeV_APC_TC_kB132_Adjusted_FTFP_BERT_HP_20.6_7.3_U");
    TH1F *hPion_mc_kB132_QGSP_BERT_HP_8_0_U = (TH1F*) mcFile.Get("hPimCal_8.0GeV_APC_TC_kB132_Adjusted_QGSP_BERT_HP_20.6_7.3_U");
    ...
    //----------------Scale MC Histos-------------------------------------------
    Int_t kB = 5;
    TH1F *scaledMC_4_kB132_QGSP_BERT = scaledHistogram(4.0, kB, imagesDir, hPion_mc_kB132_QGSP_BERT_4_0_U, peakData4, ElePim, DepCal, 0, O_U_u);
    scaledMC_4_kB132_QGSP_BERT->Rebin(3);
    TH1F *scaledMC_4_kB132_FTFP_BERT = scaledHistogram(4.0, kB, imagesDir, hPion_mc_kB132_FTFP_BERT_4_0_U, peakData4, ElePim, DepCal, 1, O_U_u);
    scaledMC_4_kB132_FTFP_BERT->Rebin(3);
    TH1F *scaledMC_4_kB132_QGSP_BERT_HP = scaledHistogram(4.0, kB, imagesDir, hPion_mc_kB132_QGSP_BERT_HP_4_0_U, peakData4, ElePim, DepCal, 3, O_U_u);
    scaledMC_4_kB132_QGSP_BERT_HP->Rebin(3);
    TH1F *scaledMC_4_kB132_FTFP_BERT_HP = scaledHistogram(4.0, kB, imagesDir, hPion_mc_kB132_FTFP_BERT_HP_4_0_U, peakData4, ElePim, DepCal, 4, O_U_u);
    scaledMC_4_kB132_FTFP_BERT_HP->Rebin(3);

    TH1F *scaledMC_6_kB132_QGSP_BERT = scaledHistogram(6.0, kB, imagesDir, hPion_mc_kB132_QGSP_BERT_6_0_U, peakData6, ElePim, DepCal, 0, O_U_u);
    scaledMC_6_kB132_QGSP_BERT->Rebin(4);
    TH1F *scaledMC_6_kB132_FTFP_BERT = scaledHistogram(6.0, kB, imagesDir, hPion_mc_kB132_FTFP_BERT_6_0_U, peakData6, ElePim, DepCal, 1, O_U_u);
    scaledMC_6_kB132_FTFP_BERT->Rebin(4);
    TH1F *scaledMC_6_kB132_QGSP_BERT_HP = scaledHistogram(6.0, kB, imagesDir, hPion_mc_kB132_QGSP_BERT_HP_6_0_U, peakData6, ElePim, DepCal, 3, O_U_u);
    scaledMC_6_kB132_QGSP_BERT_HP->Rebin(4);
    TH1F *scaledMC_6_kB132_FTFP_BERT_HP = scaledHistogram(6.0, kB, imagesDir, hPion_mc_kB132_FTFP_BERT_HP_6_0_U, peakData6, ElePim, DepCal, 4, O_U_u);
    scaledMC_6_kB132_FTFP_BERT_HP->Rebin(4);

    TH1F *scaledMC_8_kB132_QGSP_BERT = scaledHistogram(8.0, kB, imagesDir, hPion_mc_kB132_QGSP_BERT_8_0_U, peakData8, ElePim, DepCal, 0, O_U_u);
    scaledMC_8_kB132_QGSP_BERT->Rebin(5);
    TH1F *scaledMC_8_kB132_FTFP_BERT = scaledHistogram(8.0, kB, imagesDir, hPion_mc_kB132_FTFP_BERT_8_0_U, peakData8, ElePim, DepCal, 1, O_U_u);
    scaledMC_8_kB132_FTFP_BERT->Rebin(5);
    TH1F *scaledMC_8_kB132_QGSP_BERT_HP = scaledHistogram(8.0, kB, imagesDir, hPion_mc_kB132_QGSP_BERT_HP_8_0_U, peakData8, ElePim, DepCal, 3, O_U_u);
    scaledMC_8_kB132_QGSP_BERT_HP->Rebin(5);
    TH1F *scaledMC_8_kB132_FTFP_BERT_HP = scaledHistogram(8.0, kB, imagesDir, hPion_mc_kB132_FTFP_BERT_HP_8_0_U, peakData8, ElePim, DepCal, 4, O_U_u);
    scaledMC_8_kB132_FTFP_BERT_HP->Rebin(5);


    //---------------Plot--------------------------------------------------
    TCanvas *c4pList = new TCanvas("c4pList","c4pList", 1200, 800);
    ...
    scaledMC_4_kB132_QGSP_BERT->SetLineColor(col4);
    scaledMC_4_kB132_QGSP_BERT->Draw("histe same");

    scaledMC_4_kB132_QGSP_BERT_HP->SetLineColor(col10);
    scaledMC_4_kB132_QGSP_BERT_HP->Draw("histe same");

    scaledMC_4_kB132_FTFP_BERT_HP->SetLineColor(darker10);
    scaledMC_4_kB132_FTFP_BERT_HP->Draw("histe same");
    ...
    auto leg4pList = new TLegend(0.53, 0.61, 0.89, 0.89);
    leg4pList->SetBorderSize(0); leg4pList->SetFillStyle(0);leg4pList->SetTextSize(0.045);
    leg4pList->AddEntry(hData_4, "Data", "ep");
    leg4pList->AddEntry(scaledMC_4_kB132_QGSP_BERT, "MC: QGSP_BERT", "el");
    leg4pList->AddEntry(scaledMC_4_kB132_QGSP_BERT_HP, "MC: QGSP_BERT_HP", "el");
    leg4pList->AddEntry(scaledMC_4_kB132_FTFP_BERT, "MC: FTFP_BERT", "el");
    leg4pList->AddEntry(scaledMC_4_kB132_FTFP_BERT_HP, "MC: FTFP_BERT_HP", "el");
    leg4pList->Draw();
    ...
    c4pList->Print(imagesDir + "pion4GeVpList.pdf");


    TCanvas *c6pList = new TCanvas("c6pList","c6pList", 1200, 800);
    ...
    scaledMC_6_kB132_QGSP_BERT->SetLineColor(col4);
    scaledMC_6_kB132_QGSP_BERT->Draw("histe same");

    scaledMC_6_kB132_QGSP_BERT_HP->SetLineColor(col10);
    scaledMC_6_kB132_QGSP_BERT_HP->Draw("histe same");

    scaledMC_6_kB132_FTFP_BERT_HP->SetLineColor(darker10);
    scaledMC_6_kB132_FTFP_BERT_HP->Draw("histe same");
    ...
    auto leg6pList = new TLegend(0.53, 0.61, 0.89, 0.89);
    leg6pList->SetBorderSize(0); leg6pList->SetFillStyle(0);leg6pList->SetTextSize(0.045);
    leg6pList->AddEntry(hData_6, "Data", "ep");
    leg6pList->AddEntry(scaledMC_6_kB132_QGSP_BERT, "MC: QGSP_BERT", "el");
    leg6pList->AddEntry(scaledMC_6_kB132_QGSP_BERT_HP, "MC: QGSP_BERT_HP", "el");
    leg6pList->AddEntry(scaledMC_6_kB132_FTFP_BERT, "MC: FTFP_BERT", "el");
    leg6pList->AddEntry(scaledMC_6_kB132_FTFP_BERT_HP, "MC: FTFP_BERT_HP", "el");
    leg6pList->Draw();
    ...
    c6pList->Print(imagesDir + "pion6GeVpList.pdf");

    TCanvas *c8pList = new TCanvas("c8pList","c8pList", 1200, 800);
    ...
    scaledMC_8_kB132_QGSP_BERT->SetLineColor(col4);
    scaledMC_8_kB132_QGSP_BERT->Draw("histe same");

    scaledMC_8_kB132_QGSP_BERT_HP->SetLineColor(col10);
    scaledMC_8_kB132_QGSP_BERT_HP->Draw("histe same");

    scaledMC_8_kB132_FTFP_BERT_HP->SetLineColor(darker10);
    scaledMC_8_kB132_FTFP_BERT_HP->Draw("histe same");
    ...
    auto leg8pList = new TLegend(0.53, 0.61, 0.89, 0.89);
    leg8pList->SetBorderSize(0); leg8pList->SetFillStyle(0);leg8pList->SetTextSize(0.045);
    leg8pList->AddEntry(hData_8, "Data", "ep");
    leg8pList->AddEntry(scaledMC_8_kB132_QGSP_BERT, "MC: QGSP_BERT", "el");
    leg8pList->AddEntry(scaledMC_8_kB132_QGSP_BERT_HP, "MC: QGSP_BERT_HP", "el");
    leg8pList->AddEntry(scaledMC_8_kB132_FTFP_BERT, "MC: FTFP_BERT", "el");
    leg8pList->AddEntry(scaledMC_8_kB132_FTFP_BERT_HP, "MC: FTFP_BERT_HP", "el");
    leg8pList->Draw();
    ...
    c8pList->Print(imagesDir + "pion8GeVpList.pdf");
